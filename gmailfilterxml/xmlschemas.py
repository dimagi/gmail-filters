...
class EntryProperty(XmlObject):
    ...
    ROOT_NAME = 'property'
    ROOT_NS = 'http://schemas.google.com/apps/2006'
...
class Entry(XmlObject):
    ROOT_NAME = 'entry'
    ROOT_NAMESPACES = {'apps': 'http://schemas.google.com/apps/2006', 'atom': 'http://www.w3.org/2005/Atom'}
    ...
    def __init__(self, node=None, context=None, id=None, updated=None, properties=None):
...
class Feed(XmlObject):
    ...
    def __init__(self, node=None, context=None, id=None, updated=None, author_name=None, author_email=None,
                 entries=None):
